...
class _AccountVerifier:
    ...
    def github_account_access_validation_required(f):
        ...
        def wrap(*args, **kwargs):
            ...
            if not _AccountVerifier.__can_user_access_github_account(kwargs["github_account_login"]):
...
class AbstractAccountEndpoint(AbstractUserEndpoint):
    ...
    def __init__(self):
        ...
        self.method_decorators = [_AccountVerifier.github_account_access_validation_required]+ self.method_decorators
